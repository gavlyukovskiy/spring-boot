...
import org.springframework.boot.autoconfigure.jdbc.proxy.ProxyDataSourceConfiguration;
...
@Import({ Registrar.class, ProxyDataSourceConfiguration.class, DataSourcePoolMetadataProvidersConfiguration.class })
