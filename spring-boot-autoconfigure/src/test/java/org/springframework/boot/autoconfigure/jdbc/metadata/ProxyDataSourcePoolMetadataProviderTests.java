...
public class ProxyDataSourcePoolMetadataProviderTests {
	...
	public void testReturnDataSourcePoolMetadataProviderForHikari() {
		...
		ProxyDataSourcePoolMetadataProvider poolMetadataProvider = this.context.getBean(ProxyDataSourcePoolMetadataProvider.class);
	...
	public void testReturnNullForNonProxy() {
		EnvironmentTestUtils.addEnvironment(this.context,
			"spring.datasource.proxy.enabled:false");
		this.context.register(DataSourceAutoConfiguration.class,
			PropertyPlaceholderAutoConfiguration.class);
		this.context.refresh();
